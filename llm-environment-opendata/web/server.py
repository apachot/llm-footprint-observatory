...
def render_market_models_table(records):
    ...
    chart_rows.extend(
        [
            ...
            {
                "label": "Average gasoline car for 0.5 km",
                "provider": "Everyday benchmark",
                "kind": "reference",
                "prompt_energy_wh": 0.0,
                "page_energy_wh": 0.0,
                "prompt_carbon_gco2e": 117.5,
                "page_carbon_gco2e": 117.5,
            },
        ]
    )
...
<head>
  ...
  <script>
    ...
    const textReplacements = [
      ...
      ['Benchmarks integrated into the chart, all expressed over one hour or rescaled to a comparable order of magnitude: household electricity from Purdue Extension measurements (fluorescent lamp ≈ 9.3 Wh over 1 h; laptop ≈ 32 Wh over 1 h) and a 1500 W electric space heater rescaled here to 11 minutes to obtain ≈ 275 Wh; for carbon, an average gasoline car benchmark derived from the ICCT (2025) factor retained by the project (235 gCO2e/km), here rescaled to <strong>0.5 km</strong> to obtain ≈ <strong>117.5 gCO2e</strong>, close to the order of magnitude of Claude Opus 4 in the inference scenario.', 'Repères intégrés au graphique, tous exprimés sur une heure ou redimensionnés à un ordre de grandeur comparable : consommation électrique domestique issue des mesures de Purdue Extension (lampe fluorescente ≈ 9,3 Wh sur 1 h ; ordinateur portable ≈ 32 Wh sur 1 h) et radiateur électrique de 1500 W ramené ici à 11 minutes pour obtenir ≈ 275 Wh ; pour le carbone, un repère de voiture essence moyenne dérivé du facteur ICCT (2025) retenu par le projet (235 gCO2e/km), ici ramené à <strong>0,5 km</strong> pour obtenir ≈ <strong>117,5 gCO2e</strong>, proche de l’ordre de grandeur de Claude Opus 4 dans le scénario d’inférence.'],
      ['Average gasoline car for 0.5 km', 'Voiture essence moyenne sur 0,5 km'],
