...
\begin{abstract}
This paper describes the implementation of the screening proxies used in the ImpactLLM Observatory. While the observatory paper presents the comparative tables and visual results for current LLMs, this companion manuscript focuses on the algorithms that convert natural-language application descriptions into inference and training carbon estimates.
\end{abstract}
...
The remainder of this paper focuses on the technical design of the inference estimator, the training proxy, and the limits of those assumptions. The comparative environmental benchmarks, tables, and figures remain in the observatory paper, which references these methods for transparency.
...
\endhead
\hline
GPT-5.2 & 17.59 & 6.77 & 5589.28 & 4995.13 \\
\hline
GPT-5.2-pro & 17.59 & 6.77 & 5589.28 & 4995.13 \\
\hline
...
\section{Conclusion}
The contribution of this manuscript is primarily methodological: it documents how ImpactLLM transforms natural-language descriptions into vetted inference and training carbon estimates. The observatory paper provides the comparative tables and figures for the tracked models, and this companion paper makes explicit how those numbers are derived and what assumptions underlie them.
